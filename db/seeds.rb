...
puts("Création de subcatégories")

subcategory1 = Subcategory.new(name:"table")
subcategory1.category = category1
subcategory1.save!
puts "Sous-catégorie #{subcategory1.name} créée"

subcategory2 = Subcategory.new(name:"chaise")
subcategory2.category = category1
subcategory2.save!
puts "Sous-catégorie #{subcategory2.name} créée"

subcategory3 = Subcategory.new(name:"literie")
subcategory3.category = category1
subcategory3.save!
puts "Sous-catégorie #{subcategory3.name} créée"

subcategory13 = Subcategory.create!(name: "Petit électroménager", category: category1)
puts "Sous-catégorie #{subcategory13.name} créée"


subcategory5 = Subcategory.new(name:"chaussures")
subcategory5.category = category2
subcategory5.save!
puts "Sous-catégorie #{subcategory5.name} créée"

subcategory6 = Subcategory.new(name:"chemise")
...
subcategory7 = Subcategory.new(name:"rideaux")
subcategory7.category = category3
subcategory7.save!
puts "Sous-catégorie #{subcategory7.name} créée"

subcategory4 = Subcategory.new(name:"plantes")
subcategory4.category = category3
subcategory4.save!
puts "Sous-catégorie #{subcategory4.name} créée"

subcategory12 = Subcategory.new(name:"vaiselle")
subcategory12.category = category3
subcategory12.save!
puts "Sous-catégorie #{subcategory12.name} créée"


subcategory8 = Subcategory.new(name:"boisson")
subcategory8.category = category4
subcategory8.save!
puts "Sous-catégorie #{subcategory8.name} créée"

subcategory9 = Subcategory.new(name:"friandise")
subcategory9.category = category4
subcategory9.save!
puts "Sous-catégorie #{subcategory9.name} créée"

subcategory10 = Subcategory.new(name:"legumes")
subcategory10.category = category4
subcategory10.save!
puts "Sous-catégorie #{subcategory10.name} créée"

subcategory11 = Subcategory.new(name:"divers", category_id: 4)
subcategory11.category = category5
subcategory11.save!
...
product_one = Product.create!(name: "Bocal en verre", sku: "stripe-veut-un-sku", description: "Conservation longue. Style épuré. Très résistant. Nombreux modèles disponibles.", price_cents: 1000, discount_price_cents: 0, subcategory: subcategory12)
...
product_two = Product.create!(name: "Assiette plate", sku: "stripe-veut-un-sku", description: "Large choix disponible. Véritable porcelaine de qualité.", price_cents: 2000, discount_price_cents: 0, subcategory: subcategory12)
...
product_three = Product.create!(name: "Couteau suisse", sku: "stripe-veut-un-sku", description: "Véritable couteau suisse. Très bonne qualité. Garantie de 10 ans.", price_cents: 4000, discount_price_cents: 0, subcategory: subcategory11)
...
product_four = Product.create!(name: "Théière", sku: "stripe-veut-un-sku", description: "Très belle théière. Motif fleuri.", price_cents: 5000, subcategory_id: 3, discount_price_cents: 0, subcategory: subcategory13)
...
product_five = Product.create!(name: "Cafetière italienne", sku: "stripe-veut-un-sku", description: "Véritable cafetière italienne pour café déjà moulu. Coloris rouge uniquement.", price_cents: 4000, discount_price_cents: 2990, subcategory: subcategory13)
