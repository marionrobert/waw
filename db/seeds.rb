...
product_one = Product.create!(name: "Bocal en verre", sku: "stripe-veut-un-sku", description: "Conservation longue. Style épuré. Très résistant. Nombreux modèles disponibles.", price_cents: 1000, subcategory: subcategory12)
...
product_two = Product.create!(name: "Assiette plate", sku: "stripe-veut-un-sku", description: "Large choix disponible. Véritable porcelaine de qualité.", price_cents: 2000, subcategory: subcategory12)
...
product_three = Product.create!(name: "Couteau suisse", sku: "stripe-veut-un-sku", description: "Véritable couteau suisse. Très bonne qualité. Garantie de 10 ans.", price_cents: 4000, subcategory: subcategory11)
...
product_four = Product.create!(name: "Théière", sku: "stripe-veut-un-sku", description: "Très belle théière. Motif fleuri.", price_cents: 5000, subcategory_id: 3, subcategory: subcategory13)
...
product_five = Product.create!(name: "Cafetière italienne", sku: "stripe-veut-un-sku", description: "Véritable cafetière italienne pour café déjà moulu. Coloris rouge uniquement.", price_cents: 4000, subcategory: subcategory13)
